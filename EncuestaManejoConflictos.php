        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Estrategias para el manejo de conflictos</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                        Indique la frecuencia con que pone en práctica cada uno de los siguientes comportamientos, anotando el número adecuado en el espacio en blanco						
...
<li>Siempre</li>
    ...
    <footer class="page-footer font-small text-secondary pt-4"
        style="background-color:#454545; font-family:'Raleway', sans-serif;">
        <!-- Copyright -->
