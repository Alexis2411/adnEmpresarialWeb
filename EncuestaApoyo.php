    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" aria-labelledby="headingOne" data-parent="#accordion">
                                    ...
                                    <table class="table table-striped table-light">
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            <tr>
                                                <td>Ofrecimiento de retroalimentacion negativa eficaz</td>
                                                <td class="text-center">
                                                    <?php
                                          ...
                                          ?>
                                            <tr>
                                                <td>
                                                    Ofrecimiento de retroalimentacion negativa eficaz
                                                </td>
                                                <td class="text-center">
                                                    <?php
            ...
            <?php
                                            ...
                                            ?>
                                            <a class="btn btn-info" style="font-size: 9rem; width: fit-content; margin: 0;" href="PreguntasSeccion.php?ques=<?php echo $row["nombre"]; ?>">Empezar</a>
                                            <?php
                                        }
                                        ?>
