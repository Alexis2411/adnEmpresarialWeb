...
<body style="background: lightgray; font-size: 20px; line-height: 25px; margin:0; font-family:'Raleway', sans-serif;">
    ...
    <main class="main text-justify">
        <div id="queEs" class="container bg-white">
            <h1 style="margin: 40px 65px 30px;">Indicador de gestión del proceso administrativo</h1>
            <div class="row" style="margin:30px 65px 30px;">
                <h2>¿Qué es?</h2>
            ...
            <div class="row" style=" word-wrap: break-word; margin: 30px 65px 30px; ">
            ...
            <div class="row" style="margin: 30px 65px 30px; margin-bottom: 30px;">
