      ...
      <section class="text-center">
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <a href="MenuEncuestas.php" class="btn btn-primary">Empezar</a>
                <p>
          ...
          <div class="col-lg-6 mb-4">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Habilidades Personales</h5>
                <p class="card-text">
                  Evaluación del Manejo del estres
                </p>
                <a href="EncuestaEstres.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                  Solución Creativa de Problemas
                </p>
                <a href="EncuestaSolAnaCrea.php" class="btn btn-primary">Empezar</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Habilidades Interpersonales</h5>
                <p class="card-text">
                     Comunicación de Apoyo
                </p>
                <a href="EncuestaApoyo.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                     Ganar Poder e Influencia
                </p>
                <a href="EncuestaPoderInlfuencia.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                     Diagnóstico para Motivar a los Demás
                </p>
                <a href="EncuestaMotivación.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                     Manejo de Conflictos Interpersonales
                </p>
                <a href="EncuestaConInt.php" class="btn btn-primary">Empezar</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Habilidades Grupales</h5>
                <p class="card-text">
                  Facultamiento y Delegación Eficaces
                </p>
                <a href="EncuestaFaDele.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                  Facultamiento Personal
                </p>
                <a href="EncuestaFaPe.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                  Desarrollo de Equipos
                </p>
                <a href="EncuestaCompDesaE.php" class="btn btn-primary">Empezar</a>
                <p class="card-text">
                  Necesidad de Formación de Equipos
                </p>
                <a href="EncuestaNeFoE.php" class="btn btn-primary">Empezar</a>
              </div>
            </div>
          </div>
        </div>
