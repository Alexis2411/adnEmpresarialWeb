        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Personalidad Tipo A</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                        Califique el grado en que cada uno de los siguientes enunciados se aplica a su caso la mayor parte del tiempo. Enfóquese en su forma general de comportarse y de sentir.						
                        </li>
                    ...
                    <ul>
                        ...
                        <br>
                        <ol>
                        <li>La afirmación es muy común en mí</li>		
                        <li>La afirmación es algo común en mí	</li>	
                        <li>La afirmación no es para nada común en mí</li>		
                        </ol>
                        <br>
                        <li>
                        ...
                        ">
                                                        ...
                                                        <div class="card-header text-light text-center">
                                                                <a class="btn btn-info"
                                                                    ...
                                                                    href="PreguntasSecciontres.php?ques=<?php echo $row["nombre"]; ?>">Reintentar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            ?>
                                            <a class="btn btn-info mx-auto" style="font-size: 3rem; width: fit-content; margin-top: 2rem;" href="PreguntasSecciontres.php?ques=<?php echo $row["nombre"]; ?>">Empezar</a>
                                            <?php
                                        }
                                        ?>
