        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Facultamiento y Delegación Eficaces</strong></h1>
                                ...
                                <div class="card" style="margin: 2px">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if ($row["completo"] == 1) {
                                            ...
                                            ?>
                                            <a class="btn btn-info mx-auto" style="font-size: 2rem; width: fit-content; margin-top: 2rem;" href="PreguntasSeccionsiete.php?ques=<?php echo $row["nombre"]; ?>">Empezar</a>
                                            <?php
                                        }
                                        ?>
