...
<body style="background: lightgray; font-size: 20px; line-height: 25px; margin:0; font-family:'Raleway', sans-serif;">
        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Evaluacion del Autoconocimiento</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                            Este instrumento está diseñado para ayudarle a descubrir qué tanto se conoce, con la finalidad de que pueda adaptar su aprendizaje a sus necesidades específicas.

                        </li>
                        <li>

                            Cuando haya completado el cuestionario, utilice la clave de resultados que se incluye al final del capítulo, para identificar las áreas de habilidades más importantes que se tratan en este capítulo y que usted deberá dominar.
                        </li>
                    </ol>
    ...
    <!-- Pie de pagina -->
    <footer class="page-footer font-small text-secondary pt-4" style="background-color:#404040; font-family:'Raleway', sans-serif;">
        <!-- Copyright -->
