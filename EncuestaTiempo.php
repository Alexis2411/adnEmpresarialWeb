        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Administración del tiempo</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                        Al responder a los siguientes enunciados, llene cada espacio en blanco con el número de la escala de resultados que indica la frecuencia con la que usted realiza cada actividad. Evalúe su comportamiento como es, no como usted quisiera que fuera.					
...
<li>Siempre</li>
    ...
    <footer class="page-footer font-small text-secondary pt-4"
        style="background-color:#393939; font-family:'Raleway', sans-serif;">
        <!-- Copyright -->
