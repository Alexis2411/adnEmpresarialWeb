                                ...
                                <div class="card card-default" style="background:#b3e5fc;">
                                    <div class="card-header">
                                        ...
                                        <h3>
                                            ...
                                            <span class="badge
                                        <?php
                                        if ($result1["total"] / 2 <= 54) {
                                            echo $noPassed;
                                        } elseif ($result1["total"] / 2 > 54 && $result1["total"] / 2 < 63) {
                                            echo $mediumPassed;
                                        } elseif ($result1["total"] / 2 >= 63) {
                                            echo $passed;
                                        }
                                        ?>
                                        float-right">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <table class="table table-striped table-light">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 44);
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 45);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 46);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
