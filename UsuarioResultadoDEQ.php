        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid text-center">
                    <h1> Comportamientos Para el Desarrollo de Equipos </h1>
                </div><!-- /.container-fluid -->
            </section>
                                ...
                                <div class="card card-default" style="background:#b3e5fc;">
                                    <div class="card-header">
                                        ...
                                        if ($result1["total"] / 2 <= 89) {
                                            echo $noPassed;
                                        } elseif ($result1["total"] / 2 > 89 && $result1["total"] / 2 < 105) {
                                            echo $mediumPassed;
                                        } elseif ($result1["total"] / 2 >= 105) {
                                            echo $passed;
                                        }
                                        ?>
                                        float-right">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <table class="table table-striped table-light">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 71);
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 72);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            Ser un miembro eficaz del equipo
                                                        </td>
                                                        <td class="text-center">
                                                            <?php
                                                            $valor = ($p1["valor"] < 1 ? '0' :  $p1["valor"]);
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 73);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            Diagnosticar y facilitar el desarrollo del equipo
                                                        </td>
                                                        <td class="text-center">
                                                            <?php
                                                            $valor = ($p1["valor"] < 1 ? '0' :  $p1["valor"]);
