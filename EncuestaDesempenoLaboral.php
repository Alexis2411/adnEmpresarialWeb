        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Evaluación del Desempeño Laboral</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                        Responda a los siguientes enunciados, con base en su situación laboral actual.						
...
<li>Siempre</li>
    ...
    <footer class="page-footer font-small text-secondary pt-4"
        style="background-color:#444444; font-family:'Raleway', sans-serif;">
        <!-- Copyright -->
