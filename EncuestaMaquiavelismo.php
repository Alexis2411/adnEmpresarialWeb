...
<body style="background: lightgray; font-size: 20px; line-height: 25px; margin:0; font-family:'Raleway', sans-serif;">
        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Escala de Maquiavelismo</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                            A continuación se presentan varias aseveraciones. Cada una representa una opinión común, aunque no existen respuestas correctas ni incorrectas. Indique su grado de acuerdo o desacuerdo con cada reactivo, utilizando la siguiente escala.
                    ...
                    <ul>
                        ...
                        <br>
                        <li>3 Totalmente de acuerdo </li>

                        <li>2 De acuerdo </li>

                        <li>1 Parcialmente de acuerdo </li>

                        <li>-1 Parcialmente en desacuerdo </li>

                        <li>-2 En desacuerdo </li>

                        <li>-3 Totalmente en desacuerdo </li>
                        <br>
                        <li>
                ...
                <div class="col-md-12 d-flex " style="max-width: 100% ; width: 100%">
                    ...
                    ?>
                        ...
                        ">
                                                        ...
                                                        <div class="card-header text-light text-center">
                                                            <a class="btn btn-info" style="font-size: 6rem; width: fit-content; margin: 0;" href="PreguntasSeccionseis-.php?ques=<?php echo $row["nombre"]; ?>">Reintentar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!-- Pie de pagina -->
    <footer class="page-footer font-small text-secondary pt-4" style="background-color:#464646; font-family:'Raleway', sans-serif;">
        <!-- Copyright -->
