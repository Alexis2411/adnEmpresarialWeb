                                ...
                                <div class="card card-default" style="background:#b3e5fc;">
                                    <div class="card-header">
                                        ...
                                        <h3>
                                            ...
                                            <span class="badge
                                        <?php
                                        if ($result1["total"] / 2 <= 106) {
                                            echo $noPassed;
                                        } elseif ($result1["total"] / 2 > 106 && $result1["total"] / 2 < 131) {
                                            echo $mediumPassed;
                                        } elseif ($result1["total"] / 2 >= 131) {
                                            echo $passed;
                                        }
                                        ?>
                                        float-right">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <table class="table table-striped table-light">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 66);
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 67);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 68);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 69);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 70);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
