          ...
          <div class="nav nav-pills d-flex justify-content-center nav-pre" id="nav-tab" role="tablist">
            ...
            if ($preguntas) {
              ...
              foreach ($preguntas as $rows) {
                ...
                <button class="btn btn-primary btn-lg <?php echo $activo ?> <?php echo $comp ?>"
                  id="p<?php echo $rows["id_pregunta"] ?>" data-toggle="tab" href="#pr<?php echo $rows["id_pregunta"] ?>"
                  role="tab" aria-controls="pr<?php echo $rows["id_pregunta"] ?>" aria-selected="<?php echo $status ?>">
                  <?php echo $rows["numero_pregunta"] ?> </button>
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            if ($preguntas) {
              ...
              foreach ($preguntas as $row) {
                ...
                $id = $row["id_pregunta"];
                ?>
                <div class="tab-pane fade <?php echo $status ?>" id="pr<?php echo $id ?>" role="tabpanel"
                  aria-labelledby="pr<?php echo $id ?>">
                  <?php
                  ...
                  if ($preg) {
                    foreach ($preg as $columna) {
                      ...
                      ?>
                      <h3 class="text-center" style="color: #3D708D;">Bloque
                        <?php echo $columna["numero_pregunta"] ?>
                        <?php echo $columna["bloque"] ?>
                      </h3>
                      <?php
                      if ($columna["visible"]) {
                        ?>
                            ...
                            <tr style="background-color:#d9e5e7;">
                              ...
                              <td class="select-res">
                                <nav class="nav nav-pills ">
                                  ...
                                  <a class="nav-item nav-link <?php echo $action["option1"][0]; ?>"
                                    id="pre-id-<?php echo $id ?>-<?php echo $idu ?>" data-toggle="tab"
                                    href="#pre-<?php echo $id ?>" role="tab" aria-controls="pre-<?php echo $id ?>"
                                    aria-selected="<?php echo $action["option1"][1]; ?>">SI</a>

                                  <a class="nav-item nav-link <?php echo $action["option2"][0]; ?>"
                                    id="empty-id-<?php echo $id ?>-<?php echo $idu ?>" data-toggle="tab"
                                    href="#empty-<?php echo $id ?>" role="tab" aria-controls="empty-<?php echo $id ?>"
                                    aria-selected="<?php echo $action["option2"][1]; ?>" data-id="">NO</a>
                                </nav>
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <div class="tab-content" id="nav-tabContent">
                        <div
                          class="tab-pane fade <?php ($columna["visible"] ? $act = $action["option1"][0] : $act = "active show");
                          echo $act; ?>"
                          id="pre-<?php echo $id ?>" role="tabpanel" aria-labelledby="pre-id-<?php echo $id ?>">
                              ...
                              <tbody>
                                ...
                                if ($subp) {
                                  foreach ($subp as $sub) {
                                    ...
                                    <tr class="res-radio">
                                      <th scope="row">
                                        <?php echo $sub["numero_subpregunta"] ?>.-
                                        <?php echo $sub["subpregunta"] ?>
                                      </th>
                                      <?php
                                      for ($r = 1; $r < 4; $r++) {
                                        if ($sub["posicion"] != $r) {
                                          ?>
                                          <td><input type="radio" name="sub<?php echo $sub["id_subpregunta"] ?>"
                                              id="p:<?php echo $idu ?>:<?php echo $sub["id_subpregunta"] ?>:<?php echo $r ?>:<?php echo $id ?>"
                                              class="option"></td>
                                        <?php
                                        } else {
                                          ?>
                        ...
                        if ($columna["visible"]) {
                          ?>
                          <div class="tab-pane fade <?php echo $action["option2"][1]; ?>" id="empty-<?php echo $id ?>"
                            role="tabpanel" aria-labelledby="empty-id-<?php echo $id ?>"></div>
                          <?php
                        }
                        ?>
                      </div>
