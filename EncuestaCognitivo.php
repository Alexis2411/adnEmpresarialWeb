        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Indicador del Estilo cognitivo</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                        Este instrumento valora la manera en que usted reúne información, la evalúa y toma decisiones. No hay respuestas correctas o incorrectas, y la exactitud de sus resultados dependerá de la honestidad de cada una de sus respuestas.						
