        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>Locus de Control</strong></h1>
                    <p class="text-justify">
                    <h3><strong>Descripción:</strong></h3>
                    <ol>
                        <li>
                            Este cuestionario evalúa sus opiniones acerca de ciertos temas. Cada reactivo consiste en un
                            par de opciones marcadas con las letras a o b. Seleccione aquella con la que esté más de
                            acuerdo. Si usted está de acuerdo con ambas opciones hasta cierto grado, seleccione aquella
                            con la que más se identifique. Si usted no está de acuerdo con ninguna de las opciones,
                            entonces marque aquella con la que esté menos en desacuerdo.
                                                            ...
                                                            <div class="card-header">
                                                                ...
                                                                <h3>
                                                                    ...
                                                                    <span class="badge
                                                                        ...
                                                                        ($result1["total"] <= 2) {
                                                                            echo $noPassed;
                                                                        } elseif ($result1["total"] > 3 && $result1["total"] <= 6) {
                                                                            echo $mediumPassed;
                                                                        } elseif ($result1["total"] > 6) {
                                                                            echo $passed;
                                                                        }
                                                                        ?> float-right">
                        ...
                        ">
                                                        ...
                                                        <div class="card-header text-light text-center">
                                                            <a class="btn btn-info"
                                                                ...
                                                                href="PreguntasLocus.php">Reintentar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <a class="btn btn-info mx-auto"
                                                ...
                                                href="PreguntasLocus.php">Empezar</a>
                                            <?php
                                        }
                                        ?>
