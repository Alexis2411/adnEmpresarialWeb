        ...
        <div class="col-md-6">
            <div class="jumbotron bg-ligth">
                <div class="container barra">
                    <h1 class="text-center"><strong>ESCALA DE AUTOEVALUACIÓN BÁSICA Y ESENCIAL (CORE-SELF-EVALUATION-SCALE SCES)</strong></h1>
                    ...
                    <ol>
                        ...
                        <li>
                        A continuación se presentan varias afirmaciones con las que usted podría o no estar de acuerdo. Utilice la siguiente escala de respuestas para indicar su nivel de acuerdo o desacuerdo con cada aseveración.  						
