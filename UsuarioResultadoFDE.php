        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid text-center">
                    <h1> Facultamiento y Delegación</h1>
                </div><!-- /.container-fluid -->
            </section>
                                ...
                                <div class="card card-default" style="background:#b3e5fc;">
                                    <div class="card-header">
                                        ...
                                        <h3>
                                            ...
                                            <span class="badge
                                        <?php
                                        if ($result1["total"] / 2 <= 120) {
                                            echo $noPassed;
                                        } elseif ($result1["total"] / 2 > 120 && $result1["total"] / 2 < 139) {
                                            echo $mediumPassed;
                                        } elseif ($result1["total"] / 2 <= 139) {
                                            echo $passed;
                                        }
                                        ?>
                                        float-right">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <table class="table table-striped table-light">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 57);
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 58);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 59);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 60);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            Activacion de emociones positivas
                                                        </td>
                                                        <td class="text-center">
                                                            <?php
                                                            $valor = ($p1["valor"] < 1 ? '0' :  $p1["valor"]);
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 61);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 62);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 63);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 64);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <?php
                                                    $bloque = bloqueScore($_SESSION['usuario'], 65);
                                                    $p1 = $bloque->fetch_assoc();
                                                    ?>
                                                    <tr>
                                                        <td>
